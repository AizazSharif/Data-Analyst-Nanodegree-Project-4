...
<h1 style="text-align:center;">Explore and Summarize Data by Aizaz Sharif</h1>
<h2 style="color: #66ff56; text-align:center;">Udacity Data Analyst Project 4</h2>
<h3 style="color: #66ff66; text-align:center;">Red wine Dataset</h3>

<button style="display: block; margin: 0 auto;"><a href="https://s3.amazonaws.com/udacity-hosted-downloads/ud651/wineQualityReds.csv">Download dataset from here</a></button>
...
There is a new variable added in the dataset 'quality.level' based on quality variable. If quality is less than 5 then its added as low and greater than 5 then high and if equal to 5 then average.
...
```{r}
uni_qplot(free.sulfur.dioxide, xlab="Free sulfur dioxide (mg/dm^3)", binwidth=3)
...
```{r}
qplot(factor(quality.level), data=wine, geom="bar", xlab="Quality Levels") + theme_bw()
...
With the correlation coefficient of 0.476, the graph shows a positive relationship between alcohol and quality level. 
...
The relation of residual sugar with alcohol shows that average and high quality wines tends to lie where residual quality is low.
...
## Plot One
###Overall relation between Number of wines and Quality
...
## Plot Two
###Relation between wines quality and Citric acid
```{r Plot_Two}
bi_qplot(quality.level, citric.acid, "boxplot") +
  xlab("Quality level") +
...
## Plot Three
###Relation of Quality levels to density, Volatile acidity and alcohol
```{r Plot_Three}
